        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a
              ...
              aria-label="Facebook"
            >
              <svg className="w-9 h-9" fill="blue" viewBox="0 0 24 24">
            ...
            <a
              ...
              aria-label="Twitter"
            >
              <svg className="w-9 h-9" fill="black" viewBox="0 0 24 24">
            ...
            <a
              ...
              aria-label="LinkedIn"
            >
              <svg className="w-9 h-9" fill="lightblue" viewBox="0 0 24 24">
